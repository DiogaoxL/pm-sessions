...
| Ruído visual e redundância de erros de formulário             | Baixa         | Baixa   | [Mitigado via Task 02] Separação estrita entre erros estruturais (inline) e erros de negócio (banner global). Validação visual homologada.                    | Mitigado   |
