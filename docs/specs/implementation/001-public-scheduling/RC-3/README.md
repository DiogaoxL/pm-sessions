...
**Status: IN_PROGRESS (17% Concluído)**
...
| [Task 02](task-02.md) | Criar Instanciação do Service via Factory          | `TODO` | Task 01      | 2h         | Baixa        |
| [Task 03](task-03.md) | Implementar Action de Listagem de Slots            | `TODO` | Task 02      | 2h         | Baixa        |
